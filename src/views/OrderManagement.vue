        ...
        <el-tab-pane v-for="(value, name) in translation.tabs" :key="name" :label="value" :name="name">
          ...
          <template v-if="Version1()">
            ...
            <el-row class="mt-16" type="flex" justify="center" align="middle">
              ...
              <ApolloMutation :mutation="require('src/graphql/OrderManagement.gql').Verify" @done="DoneOfVerify">
            ...
            <ApolloQuery :query="require('src/graphql/OrderManagement.gql').AppInfos" :variables="{version: '1'}" :class="RequiredCheck()" @result="DoneOfAppInfos">
              <template slot-scope="{ result: { data } }">
                ...
                <el-row v-if="appInfos" class="mb-16" type="flex" align="middle" justify="center">
                  ...
                  <el-col :sm="10">
                    ...
                    <ApolloMutation v-else :mutation="require('src/graphql/OrderManagement.gql').AdvChannels" @done="DoneOfAppId">
                      <template slot-scope="{ mutate }">
                ...
                <el-row class="mb-16" type="flex" align="middle" justify="center">
                  ...
                  <el-col :sm="10">
                    ...
                    <ApolloMutation v-else :mutation="require('src/graphql/OrderManagement.gql').PayWays" @done="DoneOfPayChannel">
                      <template slot-scope="{ mutate }">
            ...
            <el-row class="mt-16 mb-16" type="flex" justify="center">
              <ApolloMutation :mutation="require('src/graphql/OrderManagement.gql').Repair" @done="DoneOfRepair">
                <template slot-scope="{ mutate }">
          ...
          <template v-else>
            ...
            <ApolloQuery :query="require('src/graphql/OrderManagement.gql').AppInfos" :variables="{version: '2'}" :class="RequiredCheck()" @result="DoneOfAppInfos">
              <template slot-scope="{ result: { data } }">
                <!-- 用户 ID -->
                <el-row class="mb-16" type="flex" align="middle" justify="center">
                  <el-col :sm="2">
