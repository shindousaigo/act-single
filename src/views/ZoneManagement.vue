      ...
      <el-tabs v-model="version" type="card" @tab-click="ChangeVersion">
        ...
        <el-tab-pane class="pane" label="区服管理v1.0" name="v1">
          ...
          <el-container v-show='version === "v1"' style="width:100%; height:100%; min-width:1200px; margin:0 auto;">
             <ApolloQuery :query="require('src/graphql/ZoneManagement.gql').games" :variables="{version:versionNum}"  @result="DoneOfGames">
            ...
            <ApolloQuery v-if='appId' :query="require('src/graphql/ZoneManagement.gql').zones" 
                  ...
                  <el-dialog title="" :visible.sync="dialogTableVisible"  :append-to-body='true' center>
                    <el-form :model="form1" :rules="rules1" :label-width="formLabelWidth" >
                      ...
                      <el-form-item v-if="formItemVariable.openTime" label="开服时间：" class="zone-time" prop="openTime"> 
                       ...
                       <ApolloQuery :query="require('src/graphql/ZoneManagement.gql').mainZoneList" :variables="{version:'1',data:{appId}}"  @result="DoneOfMainZoneList">
                        <template slot-scope="{ result: { data } }">   
                    ...
                    <ApolloMutation v-if='dialogTableVisible1' :mutation="require('src/graphql/ZoneManagement.gql').addZoneInfo" @done="DoneOfAddZone">
                    ...
                    <ApolloMutation v-else-if="dialogTableVisible2" :mutation="require('src/graphql/ZoneManagement.gql').editZoneInfo" @done="DoneOfEditZone">
                      <template slot-scope="{ mutate }">
                        <div  slot="footer" class="dialog-footer">
                          <el-row type="flex" justify='center'>
                    ...
                    <ApolloMutation v-else-if="dialogTableVisible3" :mutation="require('src/graphql/ZoneManagement.gql').mergeZone" @done="DoneOfMergeZone">
                      <template slot-scope="{ mutate }">
                        <div  slot="footer" class="dialog-footer">
                          <el-row type="flex" justify='center'>
                ...
                <el-main style="height:100%; width:80vw;min-width:750px;padding-top:0;">
                  ...
                  <el-dialog v-if='version === "v2"' title="" :visible.sync="dialogTableVisible"  :append-to-body='true' center>
                    <el-form :model="form1" :rules="rules1" :label-width="formLabelWidth" >
                      ...
                      <ApolloQuery :query="require('src/graphql/ZoneManagement.gql').mainZoneList" :variables="{version:'2',data:{appId}}"  @result="DoneOfMainZoneList">
                        <template slot-scope="{ result: { data } }">   
